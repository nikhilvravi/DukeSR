...
class checkpoint():
    ...
    def save_results(self, idx, input, output, target, scale):
        ...
        if self.args.save_results:
            ...
            filename = '{}/results/{:0>4}x4m.png'.format(self.dir,idx+901)
            tu.save_image(output.data[0] / self.args.rgb_range,filename)
...
def save_array(fname, arr):
    """Save array to a bcolz array."""
    c=bcolz.carray(arr, rootdir=fname, mode='w')
    c.flush()

def load_array(fname):
    """Load array to a bcolz array"""
