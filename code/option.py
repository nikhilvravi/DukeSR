...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../../Corrected',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='DIV2K',
                    help='test dataset name')
parser.add_argument('--n_train', type=int, default=750,
                    help='number of training set')
parser.add_argument('--n_val', type=int, default=49,
                    help='number of validation set')
parser.add_argument('--offset_val', type=int, default=750,
...
parser.add_argument('--batch_norm', action='store_true',
                    help='use batch norm in res layers')
